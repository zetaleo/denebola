function t_animate__getAttrByRes(t, a) {
    ...
    return n >= 1200 ? e = t.attr("data-animate-" + a) : "y" == t.attr("data-animate-mobile") ? n >= 960 ? ((e = t.attr("data-animate-" + a + "-res-960")) || (e = t.attr("data-animate-" + a)), e) : n >= 640 ? ((e = t.attr("data-animate-" + a + "-res-640")) || (e = t.attr("data-animate-" + a + "-res-960")), e || (e = t.attr("data-animate-" + a)), e) : n >= 480 ? ((e = t.attr("data-animate-" + a + "-res-480")) || (e = t.attr("data-animate-" + a + "-res-640")), e || (e = t.attr("data-animate-" + a + "-res-960")), e || (e = t.attr("data-animate-" + a)), e) : n >= 320 ? ((e = t.attr("data-animate-" + a + "-res-320")) || (e = t.attr("data-animate-" + a + "-res-480")), e || (e = t.attr("data-animate-" + a + "-res-640")), e || (e = t.attr("data-animate-" + a + "-res-960")), e || (e = t.attr("data-animate-" + a)), e) : void 0 : void t.css("transition", "none")
}
...
function t_animate__animateChainItemsOnScroll(t, a, e) {
    var n = $(t[a]),
        ...
        _ = t_animate__getDelayFromPreviousScrollEvent(n, i, .16),
    ...
    t.each(function () {
        ...
        if (n = n.split(";").filter(function (t, a) {
            ...
            var s = e.replace(/[^\d., ]+/g, "").match(/\d+\.\d+|\d+,\d+/g),
                r = e.replace(/<br>/g, " ").replace(/[^\d., ]+/g, "").replace(/ (\.|,)/g, "").replace(/(\d)(?=\d) /g, "$1").trim(),
                o = r;
            if (-1 === e.indexOf(r) && (o = r = r.split(" ")[0]), "" !== r) {
                var _;
                if (t.attr("data-animate-number-count", e), null !== s)
                    if (-1 !== r.indexOf(",") && (_ = r.split(",")), -1 !== r.indexOf(".") && (_ = r.split(".")), -1 !== r.indexOf(",") || -1 !== r.indexOf(".")) {
                        var m = _[1].length;
                        r = (r = +_.join(".")).toFixed(m)
                    } t_animate__changeNumberOnZero(t, e.replace(o, "num")), t.find("span:not(.t-animate__number)").each(function () {
                    $(this).attr("style", n)
                })
            }
        }
...
function t_animate__animateNumbers(t) {
    t.each(function () {
        ...
        if (t.find("span:not(.t-animate__number):first").each(function () {
            ...
            var r = 0,
                o = !1;
            t.removeAttr("data-animate-number-count"), null !== n && (o = -1 != n[0].indexOf(",")), s.forEach(function (t, a) {
                var e;
                null !== n && (-1 !== t.indexOf(",") && (e = t.split(",")), -1 !== t.indexOf(".") && (e = t.split(".")), -1 === t.indexOf(",") && -1 === t.indexOf(".") || (r = e[1].length, s[a] = +e.join("."), !0))
            });
            var _ = [];
            t.find(".t-animate__number").each(function () {
                ...
                void 0 !== _[s] && $({
                    ...
                    easing: "swing",
                    step: function (a) {
                        var e, _ = t.find(".t-animate__number")[s],
                            m = Math.pow(10, r);
                        e = a ? (Math.round(this.animateCounter * m) / m).toFixed(r) + "" : Math.floor(this.animateCounter) + "", i.length > 1 && (e = e.replace(/(\d)(?=(\d{3})+([^\d]|$))/g, "$1 ")), o && (e = e.replace(/\./g, ","), n = (n + "").replace(/\./g, ",")), $(_).text(e)
                    },
                    complete: function () {
    ...
    if (0 != n.length) {
        ...
        n.each(function () {
            ...
            if (_ < a) {
                ...
                var m = .16 * i + r;
                o.css("transition-delay", m + "s"), o.addClass("t-animate_started"), o.attr("data-animate-start-time", Date.now() + 1e3 * m), o[0] == n.last()[0] && t_animate__checkSectionButtonAnimation(t, m), i++, o.on("transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd", function () {
                    $(this).addClass("t-animate__chain_showed"), $(this).off("transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd")
                })
