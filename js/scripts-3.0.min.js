...
(window.isSafari = !1, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && (window.isSafari = !0), window.isSafariVersion = "", window.isSafari) && (null !== (version = navigator.appVersion.match(/Version\/(\d+)\.(\d+)\.?(\d+)? Safari/)) && (window.isSafariVersion = [parseInt(version[1], 10), parseInt(version[2], 10), parseInt(version[3] || 0, 10)]));
...
window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang, document.addEventListener("DOMContentLoaded", function () {
        var t = document.querySelector("#allrecords");
        if (null !== t) {
            var e = t.getAttribute("data-tilda-project-lang");
            null !== e && (window.browserLang = e)
        }
    }),
    function (t) {
    ...
    function (t) {
        t(document).ready(function () {
            if (!window.isMobile && "yes" !== t("#allrecords").attr("data-blocks-animationoff") && 0 == window.isSearchBot) {
                t(".r").each(function () {
    ...
    function (t) {
        if (window.isMobile) {
            var e = function () {
                for (var e = document.body.querySelectorAll(".t-cover__carrier"), i = t(window).height(), n = 0, o = 0, a = e.length; o < a; o++)(d = (s = e[o]).style).height.indexOf("vh") > -1 && (n = parseInt(d.height, 10) / 100, l = Math.round(i * n) + "px", (c = t(s).parent(".t-cover")) && (c = c[0]) && (h = c.querySelector(".t-cover__filter"), p = c.querySelector(".t-cover__wrapper"), h && (h.style.height = l), p && (p.style.height = l), d.height = c.style.height = l));
                var r = document.body.querySelectorAll("[data-height-correct-vh]");
                i = t(window).height(), n = 0;
                var s, d, l, c, h, p;
                for (o = 0, a = r.length; o < a; o++)(d = (s = r[o]).style).height.indexOf("vh") > -1 && (n = parseInt(d.height) / 100, l = i + "px", c = t(s).parent(".t-cover"), d.height = l)
            };
            t(document).ready(function () {
                setTimeout(function () {
                    e()
                ...
                }), t("[field]").find("span").each(function () {
                    t(this).css("font-size").replace("px", "") > 26 && t(this).css("font-size", "")
                }), t(".t-title, .t-name, .t-heading, .t-descr, .t-text, .t-subtitle").not(".tn-elem, .tn-atom, [data-auto-correct-line-height=false]").each(function () {
                    if (void 0 !== (e = t(this).attr("style")) && "" != e && e.indexOf("font-size") > -1 && t(this).css("font-size").replace("px", "") > 26)
                        if ("rem" === t(this).attr("data-auto-correct-font-size")) {
                            var i = new RegExp(/font-size.*px;/, "gi"),
                                n = e.replace(i, "font-size: 1.6rem;").replace("line-height", "lineheight");
                            t(this).attr("style", n)
                        } else {
                            n = e.replace("font-size", "fontsize").replace("line-height", "lineheight");
                            t(this).attr("style", n)
                        }
                })
            }), t(window).load(function () {
                ...
                }), t(".t-title, .t-name, .t-heading, .t-descr, .t-text, .t-subtitle").not(".tn-elem, .tn-atom").each(function () {
